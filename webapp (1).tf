...
resource "azurerm_resource_group" "WissenSatyaRG" {
  name     = "WissenSatyaRG"
  location = "east us"
}
...
resource "azurerm_app_service_plan" "appserviceplan" {
  name                = "appserviceplan"
  location            = azurerm_resource_group.WissenSatyaRG.location
  resource_group_name = azurerm_resource_group.WissenSatyaRG.name
...
resource "azurerm_app_service" "WissenWebApp" {
  name                = "WissenWebApp"
  location            = azurerm_resource_group.WissenSatyaRG.location
  resource_group_name = azurerm_resource_group.WissenSatyaRG.name
